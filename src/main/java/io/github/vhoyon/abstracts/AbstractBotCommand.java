...
import io.github.vhoyon.exceptions.BadContentException;
import io.github.vhoyon.interfaces.*;
import io.github.vhoyon.modules.Logger;
import io.github.vhoyon.objects.Buffer;
import io.github.vhoyon.objects.Mention;
import io.github.vhoyon.objects.MessageEventDigger;
import io.github.vhoyon.objects.Request;
import io.github.vhoyon.objects.Request.Parameter;
import io.github.vhoyon.res.FrameworkResources;
import io.github.vhoyon.utilities.formatting.DiscordFormatter;
 ...
 * This class has many io.github.vhoyon.utilities for handling different condition types for doing appropriate actions depending on the command you are trying to implement. They should all be available inside the {@code action()} method body, so fire up your IDE to get auto completion to know more about available methods!
 *
 * @version 1.0
 * @since v0.7.0
